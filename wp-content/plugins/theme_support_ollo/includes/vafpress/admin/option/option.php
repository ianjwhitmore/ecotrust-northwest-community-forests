<?php
return array(
    'title' => __( 'Ollo Charity Theme Options', BUNCH_NAME ),
    'logo' => get_template_directory_uri() . '/images/logo/logo5.png',
    'menus' => array(
        // General Settings
         array(
                ...
                array(
                    ...
                    'controls' => array(
                        array(
                            ...
                            'default' => get_template_directory_uri().'/images/fav-icon/favicon-56x56.png'
                        ),
                        array(
                            'type' => 'upload',
                            'name' => 'logo_image',
                            ...
                            'default' => get_template_directory_uri().'/images/logo/logo5.png'
                        ),
                        array(
                            'type' => 'upload',
						...
						array(
                            ...
                            'description' => __('On/Off the language', BUNCH_NAME),
                        ),
						array(
                            'type' => 'toggle',
                            'name' => 'search_box',
                            'label' => __('Hide/Show the Search Box', BUNCH_NAME),
                            'description' => __('Hide/Show the Search Box', BUNCH_NAME),
                        ),
						array(
                             'type' => 'select',
                            'name' => 'header_style',
                ...
                array(
                    ...
                    'controls' => array(
						array(
                            'type' => 'toggle',
                            'name' => 'hide_partners',
                            'label' => __( 'Show Partners', BUNCH_NAME ),
                            'default' => 0,
                            'description' => __('show or hide Partners', BUNCH_NAME)
                        ),
						array(
							'type' => 'builder',
							'repeating' => true,
                    		'sortable' => true,
							'label' => __( 'Our Partners', BUNCH_NAME ),
							'name' => 'our_partners',
							'description' => __( 'This section is to Partners', BUNCH_NAME ),
							'fields' => array(
								array(
								   'type' => 'upload',
									'name' => 'partner_img',
									'label' => __( 'Logo', BUNCH_NAME ),
									'description' => __( 'choose the client logo.', BUNCH_NAME ),
									'default' => '' 
								 ),
							),
						 ),
						 array(
                            ...
                            'label' => __( 'Show Call to Action', BUNCH_NAME ),
                            'default' => 0,
                            'description' => __('show or hide Contact Form', BUNCH_NAME)
                        ),
						array(
							'type' => 'section',
							'label' => __( 'Contact Form area', BUNCH_NAME ),
							'name' => 'contact_form',
							'description' => __( 'This section is to add Contact Form', BUNCH_NAME ),
							'fields' => array(
								array(
									'type' => 'textbox',
									'name' => 'contact_title',
									'label' => __( 'Title', BUNCH_NAME ),
									'description' => __( 'Enter the Contact Info Title', BUNCH_NAME ),
									'default' => 'Want to participate as a volunteer?' 
								),
								array(
									'type' => 'textbox',
									'name' => 'button_title',
								...
								array(
									'type' => 'textbox',
									'name' => 'button_url',
									'label' => __( 'Button URL', BUNCH_NAME ),
									'description' => __( 'Enter the Button URLt', BUNCH_NAME ),
                        ...
                        array(
                            ...
                            'default' => 'Copyright © 2012-2017 Consulting Theme. All rights reserved <a href="https://themeforest.net/user/unifytheme" class="tran3s ch-p-color" target="_blank">Unifytheme</a>' 
                        ),
                    ) 
                ), //End of submenu
            ) 
         ...
         // Search Page Settings 
         		...
         		array(
					...
					'controls' => array(
						array(
							'type' => 'toggle',
							'name' => 'show_404_breadcrumb',
							'label' => __( 'Show/Hide Breadcrumb', BUNCH_NAME ),
							'default' => 0,
							'description' => __('show or hide Breadcrumb', BUNCH_NAME)
							
						),
						array(
							'type' => 'section',
							'label' => __( '404 breadcrumbs Settings', BUNCH_NAME ),
							'name' => 'contact_info',
							'description' => __( 'This section is 404 Breadcrumbs Settings', BUNCH_NAME ),
							'fields' => array(
								array(
									'type' => 'textbox',
									'name' => 'breadcrumb_title',
									'label' => __( 'Title', BUNCH_NAME ),
									'description' => __( 'Enter the Breadcrumb Title', BUNCH_NAME ),
									'default' => '404' 
								),
								array(
									'type' => 'upload',
									'name' => '404_page_breadcrumb_bg',
									'label' => __( 'Breadcrumb Background Image', BUNCH_NAME ),
									'description' => __( 'Upload Image for Breadcrumb', BUNCH_NAME ),
									'default' => get_template_directory_uri() . '/images/inner-page/banner-4.jpg' 
								),
							),
						),
						array(
						...
						array(
							...
							'default' => 'Looks like somthing went wrong' 
						),
						array(
							'type' => 'textbox',
							'name' => 'description',
							'label' => __( 'Description', BUNCH_NAME ),
							'description' => __( 'Enter the Description', BUNCH_NAME ),
							'default' => 'The page you are looking for was moved, removed, renamed or might never existed.' 
						),
						array(
							'type' => 'toggle',
							'name' => 'show_404_button',
							'label' => __( 'Show Button', BUNCH_NAME ),
							'default' => 0,
							'description' => __('show or hide Button', BUNCH_NAME)
							
						),
						array(
							'type' => 'toggle',
							'name' => 'show_404_search',
							'label' => __( 'Show Search', BUNCH_NAME ),
							'default' => 0,
							'description' => __('show or hide Search', BUNCH_NAME)
							
						),
						array(
							 'type' => 'textarea',
							'name' => '404_button_title',
							'label' => __( '404 Button Title', BUNCH_NAME ),
							'description' => __( 'Enter the Button Title you want to show on 404 page', BUNCH_NAME ),
							'default' => 'Go Back Home Page' 
						),
					),
				),
			),

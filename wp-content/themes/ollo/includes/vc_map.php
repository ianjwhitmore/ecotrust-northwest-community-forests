...
//Services
ollo_vc_map( array(
			"name" => esc_html__("bbPress Forums", 'ollo'),
			"base" => "bbp-forum-index",
			"class" => "",
			"category" => esc_html__('Jollyall', 'ollo'),
			"icon" => 'faqs' ,
			"params" => array(				
				array(
				   "type" => "textfield",
...
$param = array(
  ...
  "holder" => "div",
  "class" => "",
  "heading" => esc_html__("Container", 'ollo'),
  "param_name" => "container",
  "value" => array('Center Page'=>true),
  "description" => esc_html__("Choose whether you want to add a container before row or not.", 'ollo')
);

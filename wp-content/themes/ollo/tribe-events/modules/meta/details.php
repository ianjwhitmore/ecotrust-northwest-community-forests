 ...
 * @var int Event post id
 */
$time_title = apply_filters( 'tribe_events_single_event_time_title', esc_html__( 'Time:', 'edutech' ), $event_id );
...
<div class="tribe-events-meta-group tribe-events-meta-group-details info-block">
	<h3 class="tribe-events-single-section-title"> <?php esc_html_e( 'Event Details', 'edutech' ) ?> </h3>
	<ul class="list">
		...
		if ( tribe_event_is_all_day() && tribe_event_is_multiday() ) :
			...
			<li><span class="icon flaticon-time"></span> <?php esc_html_e( 'Start:', 'edutech' ) ?>
			...
			<li><span class="icon flaticon-time"></span> <?php esc_html_e( 'End:', 'edutech' ) ?>
		...
		elseif ( tribe_event_is_all_day() ):
			...
			<li> <span class="icon flaticon-time-6"></span> <?php esc_html_e( 'Date:', 'edutech' ) ?>
				<abbr class="tribe-events-abbr tribe-events-start-datetime published dtstart" title="<?php esc_attr( $start_ts ) ?>"> <?php echo balanceTags( $start_date ) ?> </abbr>
			</li>
		...
		if ( ! empty( $cost ) ) : ?>
			...
			<li> <?php esc_html_e( 'Cost:', 'edutech' ) ?>
		...
		<?php echo tribe_meta_event_tags( sprintf( esc_html__( '%s Tags:', 'edutech' ), tribe_get_event_label_singular() ), ', ', false ) ?>

		<?php
		// Event Website
		if ( ! empty( $website ) ) : ?>

			<li> <?php esc_html_e( 'Website:', 'edutech' ) ?> 

                ...
                <div class="theme-blog-large-sideOne">
                    ...
                    <div class="blog-details-content recent-news">
                        ...
                        <div class="single-news">
							 ...
							 <div class="breadcrumbs"><?php echo wp_kses_post(ollo_get_the_breadcrumb()); ?></div>
	                         <h1 class="titled"><?php if($title) echo wp_kses_post($title); else wp_title('');?></h1>

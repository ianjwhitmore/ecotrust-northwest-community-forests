 ...
 * @author  Unify Theme <foqrul.munna@gmail.com>
 ...
 */
 add_action( 'wp_enqueue_scripts', 'ollo_child_scripts' );
 
function ollo_child_scripts() {
...
add_filter( 'body_class', function( $classes ) {
    return array_merge( $classes, array( 'child-theme' ) );
} );
